...
import cn.wsy.adapter.interfaces.GeneralViewSetter;


/**
 * viewholder --> 为convertView提供控件对象支持
 * Created by wsy on 2016/7/20.
 */
public class MyViewHolder extends RecyclerView.ViewHolder implements GeneralViewSetter<MyViewHolder> {

    private View convertView;
    private int realPostion;
    private SparseArray<View> childViews = new SparseArray<View>();

    public MyViewHolder(View itemView, int realPostion) {
        super(itemView);
    ...
    //解决复用
    public static MyViewHolder get(View convertView, View itemView){
        MyViewHolder holder;
        if (convertView == null){
            convertView = itemView;
            holder = new MyViewHolder(itemView);
            convertView.setTag(holder);//layout绑定处理对象
        }else{
    ...
    @Override
    public MyViewHolder setTextColor(int viewId, ColorStateList colorStateList) {
    ...
    @Override
    public MyViewHolder setMovementMethod(int viewId, MovementMethod method) {
        TextView textView = getView(viewId);
    ...
    @Override
    public MyViewHolder setImageResource(int viewId, int imgResId) {
    ...
    @Override
    public MyViewHolder setImageUri(int viewId, Uri imageUri) {
        ImageView view = getView(viewId);
    ...
    @Override
    public MyViewHolder setScaleType(int viewId, ImageView.ScaleType type) {
        ImageView view = getView(viewId);
    ...
    @Override
    public MyViewHolder setBackgroundColor(int viewId, int bgColor) {
    ...
    @Override
    public MyViewHolder setBackgroundResource(int viewId, int bgRes) {
        View view = getView(viewId);
    ...
    @Override
    public MyViewHolder setColorFilter(int viewId, ColorFilter colorFilter) {
        ImageView view = getView(viewId);
    ...
    @Override
    public MyViewHolder setColorFilter(int viewId, int colorFilter) {
        ImageView view = getView(viewId);
        view.setColorFilter(colorFilter);
        return this;
    }
    ...
    @Override
    public MyViewHolder setAlpha(int viewId, @FloatRange(from = 0.0, to = 1.0) float value) {
        View view = getView(viewId);
    ...
    @Override
    public MyViewHolder setAdapter(int viewId, Adapter adapter) {
    ...
    @Override
    public MyViewHolder setAdapter(int viewId, RecyclerView.Adapter adapter) {
